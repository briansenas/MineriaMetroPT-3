...
\begin{figure}[H]
        \centering
     \subfloat{\includegraphics[width=0.7\textwidth]{imgs/funcion_sigmoide.png}}
...
\begin{figure}[H]
        \centering
        \subfloat{\includegraphics[width=0.7\textwidth]{imgs/pca.png}}
...
\begin{figure}[htp]
\centering
\subfloat{\includegraphics[width=0.4\textwidth]{BayesMatrix}}
\subfloat{\includegraphics[width=0.4\textwidth]{BayesMatrixResults}}
...
\begin{figure}[htp]
    \centering
    \subfloat{\includegraphics[width=0.7\textwidth]{random_vs_grid.png}}
...
\begin{figure}[htp]
    \centering
    \subfloat{\includegraphics[width=0.9\textwidth]{feature_importance.png}}
...
\begin{figure}[htp]
    ...
    {test_decision_tree_confusion_matrix_decision_tree.png}}
    \subfloat{\includegraphics[width=0.5\textwidth]{decision_tree_confusion_matrix_decision_tree.png}}
...
\begin{figure}[htp]
    \centering
    \subfloat{\includegraphics[width=0.9\textwidth]{tree_visualization.png}}
...
\begin{figure}[htp]
    \centering
    \subfloat{\includegraphics[width=0.9\textwidth]{feature_importance_xgboost.png}}
...
\begin{figure}[htp]
    \centering
    \subfloat{\includegraphics[width=0.5\textwidth]
    {test_xgboost_confusion_matrix_decision_tree.png}}
    \subfloat{\includegraphics[width=0.5\textwidth]{xgboost_confusion_matrix_decision_tree.png}}
...
\begin{figure}[htp]
\centering
\subfloat{\includegraphics[width=0.4\textwidth]{StackingMatrix}}
\subfloat{\includegraphics[width=0.4\textwidth]{StackingMatrixResults}}
